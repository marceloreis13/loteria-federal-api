...
class HtmlQuina extends AbstractReaderHtmlLoteria
{
    public function getData()
    {
        $this->numbersNode->setNumberConcurso(0)
            ...
            ->setTotalGanhadoresPrimeiroPremio(8)
            ->setTotalGanhadoresSegundoPremio(12)
            ->setTotalGanhadoresTerceiroPremio(14)
            ->setValorGanhadoresPrimeiroPremio(11)
            ->setValorGanhadoresSegundoPremio(13)
            ->setValorGanhadoresTerceiroPremio(15)
            ->setValorAcumuladoConcurso(19)
            ->setValorEstimadoProximoConcurso(20);
