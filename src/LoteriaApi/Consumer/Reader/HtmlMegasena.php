...
class HtmlMegasena extends AbstractReaderHtmlLoteria
{
    public function getData()
    {
        $this->numbersNode->setNumberConcurso(0)
            ...
            ->setTotalGanhadoresPrimeiroPremio(9)
            ->setTotalGanhadoresSegundoPremio(13)
            ->setTotalGanhadoresTerceiroPremio(15)
            ->setValorGanhadoresPrimeiroPremio(12)
            ->setValorGanhadoresSegundoPremio(14)
            ->setValorGanhadoresTerceiroPremio(16)
            ->setValorAcumuladoConcurso(18)
            ->setValorEstimadoProximoConcurso(19);
    ...
    public function getDataLive() {
        ...
        $arrecadacao = trim(preg_replace('/[^0-9,\.]/si', '', $nodes->item(3)->nodeValue));
